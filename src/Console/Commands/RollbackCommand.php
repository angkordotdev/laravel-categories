...
#[AsCommand(name: 'angkor:rollback:categories')]
class RollbackCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'angkor:rollback:categories {--f|force : Force the operation to run when in production.}';
     ...
     * @var string
     */
    protected $description = 'Rollback Angkor Categories Tables.';
